...
Styles[iStylePT++] = BuildStylePT("Blunt", "8", "Slam", "Any", "Taunt", "Medium", "Low", "Medium Bonus", "Medium Penalty", "", "Increases your threat to monster targets by 17 damage.", "0,575");
Styles[iStylePT++] = BuildStylePT("Blunt", "10", "Side Bash", "To side of target", "Slowed", "Medium", "Medium", "Low Bonus", "No Bonus", "Unstoppable Force", "Target's attack speed reduced by 19% for 20 seconds.", "0,604");
Styles[iStylePT++] = BuildStylePT("Blunt", "12", "Impact", "Bruiser", "Bleed", "Low", "Medium", "Medium bonus", "Low Penalty", "Windfall", "Bleed 4 body dmg every 4 sec for 20 sec", "0,880");
Styles[iStylePT++] = BuildStylePT("Blunt", "15", "Windfall", "Impact", "Slowed", "Low", "Medium", "High Bonus", "Low Bonus", "Bone Crusher", "Target's attack speed reduced by 22% for 20 seconds.", "0,880");
Styles[iStylePT++] = BuildStylePT("Blunt", "18", "Force of Might", "Any", "", "High", "Medium", "Low Bonus", "No Bonus", "Bonecrusher", "none", "0,448");
Styles[iStylePT++] = BuildStylePT("Blunt", "21", "Unstoppable Force", "Sidebash", "Snare", "Medium", "Medium", "Medium Bonus", "Low Bonus", "Mauler", "Taget moves 60% slower for 19 seconds.", "0,838");
Styles[iStylePT++] = BuildStylePT("Blunt", "25", "Back Crush", "Behind Target", "None", "Medium", "High", "Medium Bonus", "Medium Penalty", "Crushing Blow", "None", "0,721");
Styles[iStylePT++] = BuildStylePT("Blunt", "29", "Bone Crusher", "Windfall", "Bleed", "Low", "Medium", "Medium Bonus", "Low Bonus", "", "Bleed 7 body dmg every 4 sec for 40 sec", "0,880");
Styles[iStylePT++] = BuildStylePT("Blunt", "34", "Mauler", "Unstoppable Force", "", "Medium", "High", "Medium Bonus", "Medium Bonus", "", "None", "0,877");
Styles[iStylePT++] = BuildStylePT("Blunt", "39", "Stunning Blow", "Parry", "Slowed", "Low", "Medium", "Medium Bonus", "Low Bonus", "Devastating Blow", "Target's attack speed reduced by 30% for 20 seconds.", "0,880");
...
Styles[iStylePT++] = BuildStylePT("Pierce", "6", "Bumblebees Sting", "Any", "Taunt", "Medium", "Low", "Medium Bonus", "High Penalty", "", "Increases your threat to monster targets by 17 damage.", "0,572");
...
Styles[iStylePT++] = BuildStylePT("Pierce", "10", "Scorpion", "Any", "Detaunt", "Medium", "None", "No Bonus", "Medium Bonus", "", "Decreases your threat to monster targets by 19 damage", "0,000");
...
Styles[iStylePT++] = BuildStylePT("Celtic Spear", "8", "Hunters Barb", "Any", "Detaunt", "Medium", "None", "No Bonus", "High Bonus", "", "Decreases your threat to monster targets by 19 damage", "0,000");
...
Styles[iStylePT++] = BuildStylePT("Celtic Dual", "29", "Tempest", "Ice Storm", "Bleed", "Medium", "High", "Medium Bonus", "No Bonus", "Supernova", "Bleed for 15 body damage every 4.0 sec for 40 seconds.", "0,973");
...
Styles[iStylePT++] = BuildStylePT("Large Weapons", "15", "Domination", "Any", "Slowed", "High", "", "Low Bonus", "Low Penalty", "", "", "0,429");
...
Styles[iStylePT++] = BuildStylePT("Scythe", "2", "Reaper", "Any", "", "High", "Very Low", "No Bonus", "No Bonus", "", "", "0,055");
Styles[iStylePT++] = BuildStylePT("Scythe", "4", "Sawgrass", "You parry", "Pierce Armor", "Low", "High", "Low Bonus", "No Bonus", "Thorny Shield", "Reduce slash resistance of target by 15% for 20 sec", "0,907");
Styles[iStylePT++] = BuildStylePT("Scythe", "6", "Taunting Scythe", "Any", "Taunt", "Medium", "Low", "No Bonus", "Medium Penalty", "", "Increases your threat to monster targets by 17 damage.", "0,592");
Styles[iStylePT++] = BuildStylePT("Scythe", "8", "Arboreal Fire", "You evade", "Add damage", "Low", "Medium", "Medium Bonus", "No Bonus", "Foxfire", "Scythe of Flame gives the Valewalker an additional 2 DPS 30 sec", "0,890");
Styles[iStylePT++] = BuildStylePT("Scythe", "10", "Stunning Blade", "To side of target", "Stun", "Medium", "Medium", "Medium Bonus", "No Bonus", "Winter's Scythe", "Target cannot move or take any other action for 5 seconds.", "0,890");
Styles[iStylePT++] = BuildStylePT("Scythe", "12", "Foxfire", "Arboreal Fire", "DoT", "Low", "High", "High Bonus", "No Bonus", "Flaming Scythe", "Flickering Flame: inflicts 18 heat damage to the target every 4.0 sec for 20 seconds.", "0,945");
Styles[iStylePT++] = BuildStylePT("Scythe", "15", "Thorny Shield", "Sawgrass", "Damage shield", "Low", "High", "Low Bonus", "High", "Grasping Roots", "Thornsprout casts a damage shield proc 4 dps 30 sec", "1,184");
Styles[iStylePT++] = BuildStylePT("Scythe", "18", "Winter's Scythe", "Stunning Blade", "Add damage", "Low", "Medium", "Low Bonus", "No Bonus", "Blizzard Blade", "Scythe of Ice adds 4 DPS to every swing for 30 sec", "0,890");
Styles[iStylePT++] = BuildStylePT("Scythe", "21", "Grasping Roots", "Thorny Shield", "AoE DD", "Very Low", "High", "Medium Bonus", "High", "", "Spray of Needles (AOE) casts a direct damage spell with an area of 350 on the target for 33 damage.", "1,310");
Styles[iStylePT++] = BuildStylePT("Scythe", "25", "Nature's Shield", "Any", "Block ranged", "Medium", "None", "No Bonus", "No Bonus", "", "Block ranged attack until another style is used.", "0,000");
Styles[iStylePT++] = BuildStylePT("Scythe", "29", "Blizzard Blade", "Winter's Scythe", "AoE DD", "Low", "Medium", "Medium Bonus", "No Bonus", "", "Frigid Mists (AOE) casts a direct damage spell with an area of 350 upon the target for 198 damage", "0,897");
Styles[iStylePT++] = BuildStylePT("Scythe", "34", "Arboreal Shield", "Any", "Detaunt", "Medium", "None", "No Bonus", "Medium", "Conflagration", "Decreases your threat to monster targets by 19 damage", "0,000");
Styles[iStylePT++] = BuildStylePT("Scythe", "39", "Flaming Scythe", "Foxfire", "AoE DD", "Very Low", "High", "High Bonus", "No Bonus", "", "Immolating Sphere (AOE) casts a direct damage spell with an area of 350 upon the target for 57 damage.", "1,193");
Styles[iStylePT++] = BuildStylePT("Scythe", "44", "Damaging Grasp", "Behind target", "Stun", "Very Low", "High", "Medium Bonus", "No Bonus", "", "Target cannot move or take any other action for 8 seconds.", "1,024");
Styles[iStylePT++] = BuildStylePT("Scythe", "50", "Conflagration", "Arboreal Shield", "DD", "High", "High", "Medium Bonus", "Medium Penalty", "", "Conflagaration casts a direct damage spell with heat damage upon the target for 95 damage.", "1,300");
