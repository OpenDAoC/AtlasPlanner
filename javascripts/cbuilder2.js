...
function bBonus(inc) {
    if(parseInt(myGetObject("BONUS").value) + inc >= 0){myGetObject("BONUS").value = parseInt(myGetObject("BONUS").value) + inc;}
else{myGetObject("BONUS").value = 0;}
...
Styles = new Array();var iStylePT=1;
// -- Common Styles -- //
...
Styles[iStylePT++]=BuildStylePT("Crit Strike", "2", "Backstab", "Behind target, stealthed", "Stun", "Medium", "Very Low", "Medium Bonus", "Medium Penalty", "Eviscerate", "Target cannot moves or take any other action for 2 seconds.", "0,000");
...
Styles[iStylePT++]=BuildStylePT("Crit Strike", "10", "Backstab II", "Behind target, stealthed", "Stun", "High", "High", "High Bonus", "Medium Penalty", "Thigh Cut", "Target cannot moves or take any other action for 3 seconds.", "0,000");
...
Styles[iStylePT++]=BuildStylePT("Crit Strike", "34", "Creeping Death", "Perforate Artery", "Stun", "Low", "High", "High Bonus", "No Bonus", "Stunning Stab", "Target cannot moves or take any other action for 7 seconds.", "1,070");
...
Styles[iStylePT++]=BuildStylePT("Crush", "34", "Side Crush", "To Side of target", "Bleed", "Medium", "Medium", "Medium Bonus", "No Bonus", "", "Bleed for 8 body damage every 4.0 seconds for 40 seconds.", "0,751");
...
Styles[iStylePT++]=BuildStylePT("Slash", "2", "Ruby Slash", "None", "", "High", "Very Low", "No Bonus", "No Bonus", "", "", "0,035");
...
Styles[iStylePT++]=BuildStylePT("Slash", "6", "Uppercut", "", "", "Medium", "Medium", "Low Bonus", "No Bonus", "Opal Slash, Cleave", "", "0,341");
Styles[iStylePT++]=BuildStylePT("Slash", "8", "Enrage", "", "Taunt", "Medium", "Medium", "No Bonus", "Medium Penalty", "Sapphire Slash", "Increase your target threat to monster targets by 17 damage.", "0,572");
...
Styles[iStylePT++]=BuildStylePT("Slash", "12", "Reflect", "", "Detaunt", "Medium", "None", "No Bonus", "Medium Bonus", "", "Decreases your target threat to monster targets by 19 damage.", "0,000");
...
Styles[iStylePT++]=BuildStylePT("Slash", "29", "Amethyst Slash", "", "", "Medium", "Low", "Very High Bonus", "No Bonus", "Diamond Slash", "", "0,555");
...
Styles[iStylePT++]=BuildStylePT("Thrust", "4", "Raftang", "You Evade", "Stun", "Low", "Low", "Medium Bonus", "Low Bonus", "Wolftooth", "Target cannot move or take any other action for 2 seconds.", "0,874");
...
Styles[iStylePT++]=BuildStylePT("Thrust", "10", "Wolftooth", "Raftang", "Snare", "Medium", "Low", "Medium Bonus", "No Bonus", "", "Target moves 60% slower for 12 seconds", "0,871");
...
Styles[iStylePT++]=BuildStylePT("Thrust", "18", "Tranquilize", "Any", "Detaunt", "Medium", "None", "No Bonus", "Medium Bonus", "", "Decreases your taget threat to monster by 19 damage.", "0,000");
...
Styles[iStylePT++]=BuildStylePT("Thrust", "39", "Basilikfang", "To side of target", "Slowed", "Medium", "Low", "Low Bonus", "Low Bonus", "", "Target's attack speed reduced b 34% for 20 seconds.", "0,781");
...
Styles[iStylePT++]=BuildStylePT("Polearm", "29", "Mangle", "Crippling Blow", "", "Medium", "High", "No Bonus", "No Bonus", "", "", "0,767");
...
Styles[iStylePT++]=BuildStylePT("2-Hand", "44", "Two Moons", "Onslaught", "Stun", "Low", "Medium", "High Bonus", "No Bonus", "", "Target cannot moves or take any other action for 9 seconds.", "0,858");
Styles[iStylePT++]=BuildStylePT("2-Hand", "50", "Sun and Moon", "Doubler", "Stun", "Medium", "High", "Low Bonus", "No Bonus", "", "Target cannot moves or take any other action for 7 seconds.", "0,957");
...
Styles[iStylePT++]=BuildStylePT("Dual Wield", "44", "Hyptonic Darkness", "Reflection", "Stun", "Medium", "Low", "High Bonus", "No Bonus", "", "Target cannot moves or take any other action for 7 seconds.", "0,859");
...
Styles[iStylePT++]=BuildStylePT("Staff", "6", "Friar's Ally", "Figure Eight", "Stun", "Medium", "Medium", "High Bonus", "No Bonus", "", "Target cannot moves or take any other action for 3 seconds.", "0,856");
...
Styles[iStylePT++]=BuildStylePT("Staff", "44", "Stunning Wrath", "Banish", "Stun", "Medium", "Medium", "High Bonus", "Medium Bonus", "", "Target cannot moves or take any other action for 8 seconds.", "0,856");
...
Styles[iStylePT++]=BuildStylePT("Flexible", "10", "Viper", "You Block", "Stun", "Low", "High", "Medium Bonus", "Low Bonus", "Copperhead", "Target cannot moves or take any other action for 5 seconds.", "0,876");
...
Styles[iStylePT++]=BuildStylePT("Flexible", "39", "Anaconda", "Tigersnake", "Stun", "Medium", "High", "High Bonus", "Low Bonus", "", "Target cannot moves or take any other action for 9 seconds.", "0,996");
...
Styles[iStylePT++]=BuildStylePT("Blades", "21", "Horizon Blade", "You Block", "Stun", "Low", "High", "Medium Bonus", "Low Bonus", "Dancing Blade", "Target cannot moves or take any other action for 4 seconds.", "0,867");
...
Styles[iStylePT++]=BuildStylePT("Celtic Dual", "18", "Ice Storm", "To side of target", "Stun", "Medium", "High", "Medium Bonus", "No Bonus", "Tempest", "Target cannot moves or take any other action for 4 seconds.", "0,763");
...
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "2", "Backstab", "Behind target, stealthed", "Stun", "Medium", "Very Low", "Medium Bonus", "Medium Penalty", "Eviscerate", "Target cannot moves or take any other action for 2 seconds.", "N/A");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "4", "Eviscerate", "Backstab", "Slowed", "Medium", "High", "Low Bonus", "Low Penalty", "Kidney Rupture", "Target's attack speed reduced by 16% for 20 seconds.", "0,617");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "6", "Kidney Rupture", "Eviscerate", "Bleed", "Low", "High", "Low Bonus", "Medium Penalty", "", "Bleed for 4 body damage every 4.0 sec for 25 seconds.", "0,669");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "8", "Pincer", "To side of target", "", "Medium", "High", "High Bonus", "High Penalty", "", "", "0,877");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "10", "Backstab II", "Behind target, stealthed", "Stun", "High", "High", "High Bonus", "Medium Penalty", "Thigh Cut", "Target cannot moves or take any other action for 3 seconds.", "N/A");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "12", "Hamstring", "You Evade", "Bleed", "Low", "High", "Medium Bonus", "Medium Bonus", "Leaper", "Bleed for 5 body damage every 4.0 sec for 30 seconds.", "1,100");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "15", "Thigh Cut", "Backstab II", "", "Medium", "High", "Medium Bonus", "Low Penalty", "", "", "1,040");
//Styles[iStylePT++]=BuildStylePT("Crit Strike", "18", "Garrote", "Any", "Snare", "High", "High", "Medium Bonus", "Medium Penalty", "Achille Heel", "Target moves 60% slower for 12 seconds.", "0,721");
...
Styles[iStylePT++]=BuildStylePT("Large Weapons", "12", "Hibernian Vigor", "Celtic Rage", "Stun", "Medium", "", "Medium Bonus", "Low Bonus", "Gigantic Blow", "Target cannot moves or take any other action for 2 seconds.", "0,883");
...
Styles[iStylePT++]=BuildStylePT("Large Weapons", "29", "Ultimate Recovery", "Target parried", "Stun", "Medium", "", "Medium Bonus", "Low Penalty", "Devastate", "Target cannot moves or take any other action for 6 seconds.", "0,917");
...
Styles[iStylePT++]=BuildStylePT("Large Weapons", "50", "Annihiliation", "Behind target", "", "Medium", "", "Very High Bonus", "Medium Penalty", "", "Target cannot moves or take any other action for 9 seconds.", "0,883");
...
Styles[iStylePT++]=BuildStylePT("Scythe", "10", "Stunning Blade", "To side of target", "Stun", "M", "Medium", "Medium Bonus", "No Bonus", "Winter's Scythe", "Target cannot moves or take any other action for 5 seconds.", "0,890");
...
Styles[iStylePT++]=BuildStylePT("Scythe", "44", "Damaging Grasp", "Behind target", "Stun", "VL", "High", "Medium Bonus", "No Bonus", "", "Target cannot moves or take any other action for 8 seconds.", "1,024");
...
Styles[iStylePT++]=BuildStylePT("Sword", "4", "Frost Cut", "You Block", "Bleed", "Low", "Medium", "Low Bonus", "No Bonus", "", "Bleed for 4 body damage every 4.0 sec for 25 seconds.", "0,865");
...
Styles[iStylePT++]=BuildStylePT("Axe", "44", "Arctif Rift", "Evernight", "", "Low", "High", "Medium Bonus", "No Bonus", "", "", "0,945");
...
Styles[iStylePT++]=BuildStylePT("Left Axe", "44", "Icy Brillance", "Snowsquall", "Bleed", "Medium", "Medium", "High Bonus", "No Bonus", "Aurora Borealis", "Bleed for 9 body damage every 4.0 sec for 40 seconds.", "1,101");
Styles[iStylePT++]=BuildStylePT("Left Axe", "50", "Aurora Borealis", "Icy Brillance", "DD", "Low", "High", "High Bonus", "No Bonus", "", "Does 95 cold damage to the target", "1,267");
//Styles[iStylePT++]=BuildStylePT("Shield", "3", "Numb", "Any", "Stun", "High", "Low", "No Bonus", "No Bonus", "", "Target cannot move or take any other action for 2 seconds.", "0,047");
//Styles[iStylePT++]=BuildStylePT("Shield", "8", "Stun", "You Block", "Stun", "High", "Low", "No Bonus", "No Bonus", "", "Target cannot move or take any other action for 3 seconds.", "0,840");
//Styles[iStylePT++]=BuildStylePT("Shield", "13", "Disable", "To side of target", "Stun", "High", "Low", "No Bonus", "No Bonus", "", "Target cannot move or take any other action for 4 seconds.", "0,645");
//Styles[iStylePT++]=BuildStylePT("Shield", "18", "Incapacitate", "You Block", "Stun", "Very High", "Low", "No Bonus", "Medium Bonus", "", "Target cannot move or take any other action for 5 seconds.", "0,859");
