...
Lines[45099]=new linePT('Cure Nearsight','Removes the given condition from the target. This spell\'s cast time is not influenced by stats.',45,0) 
Spells[idx++]=new spellPT("Cure Nearsight I",20,45099,45,'',45,'30 PP','1500','6.0s','','','','') 
Spells[idx++]=new spellPT("Cure Nearsight II",35,45099,45,'',45,'30 PP','1500','3.5s','','','','')
...
Spells[idx++]=new spellPT("Nature's Revenge",5,49061,49,"1.3 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Vendetta",9,49061,49,"1.9 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Vengeance",14,49061,49,"2.7 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Retaliation",19,49061,49,"3.7 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Retribution",25,49061,49,"4.3 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Feud",35,49061,49,"5.8 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Spells[idx++]=new spellPT("Nature's Reckoning",46,49061,49,"7.5 DPS ",49,"",'1500','','','8s','5s (pulse)','') 
Lines[49086]=new linePT('Buff (Group, Body Resistance)','Target\'s resistance to Body damage is increased.',49,0) 
Spells[idx++]=new spellPT("Bolster Health",22,49086,49,"+8 BODY ",49,"18 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Bolster Resillience",32,49086,49,"+16 BODY ",49,"26 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Bolster Heartiness",43,49086,49,"+24 BODY ",49,"36 PP",'1000','3.0s','','','20m','') 
Lines[49087]=new linePT('Buff (Group, Spirit Resistance)','Target\'s resistance to Spirit damage is increased.',49,0) 
Spells[idx++]=new spellPT("Warden's Courage",23,49087,49,"+8 SPIRIT ",49,"19 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Warden's Honor",33,49087,49,"+16 SPIRIT ",49,"27 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Warden's Spirit",48,49087,49,"+24 SPIRIT ",49,"41 PP",'1000','3.0s','','','20m','') 
Lines[49088]=new linePT('Buff (Group, Energy Resistance)','Target\'s resistance to Energy damage is increased.',49,0) 
Spells[idx++]=new spellPT("Defy Thunder",27,49088,49,"+8 ENERGY ",49,"22 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Defy Storm",37,49088,49,"+16 ENERGY ",49,"31 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Defy Lightning",49,49088,49,"+24 ENERGY ",49,"42 PP",'1000','3.0s','','','20m','') 
