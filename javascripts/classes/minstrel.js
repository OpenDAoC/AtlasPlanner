...
Spells[2]=new spellPT("Song of Renewal",8,5067,5,"8 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[3]=new spellPT("Song of Minor Healing",14,5067,5,"13 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[4]=new spellPT("Song of Healing",19,5067,5,"17 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[5]=new spellPT("Song of Minor Regeneration",25,5067,5,"22 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[6]=new spellPT("Song of Regeneration",31,5067,5,"26 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[7]=new spellPT("Song of Minor Rejuvenation",37,5067,5,"31 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[8]=new spellPT("Song of Rejuvenation",47,5067,5,"39 HP ",5,"",'700','3.0s','','','6s (pulse)','') 
...
Spells[9]=new spellPT("Dischordant Note",2,105069,5,"7  D ",5,"2 PP",'700','','','15s','','Body') 
Spells[10]=new spellPT("Dischordant Tone",7,105069,5,"21  D ",5,"5 PP",'700','','','15s','','Body') 
Spells[11]=new spellPT("Dischordant Wail",17,105069,5,"46  D ",5,"10 PP",'700','','','15s','','Body') 
Spells[12]=new spellPT("Dischordant Shriek",35,105069,5,"92  D ",5,"22 PP",'700','','','15s','','Body') 
Spells[13]=new spellPT("Discordant Howl",43,105069,5,"111  D ",5,"27 PP",'700','','','15s','','Body') 
...
Spells[14]=new spellPT("Lesser Cacophony",4,5069,5,"12  D ",5,"3 PP",'700','','','15s','','Body') 
Spells[15]=new spellPT("Cacophony",12,5069,5,"32  D ",5,"8 PP",'700','','','15s','','Body') 
Spells[16]=new spellPT("Greater Cacophony",26,5069,5,"69  D ",5,"16 PP",'700','','','15s','','Body') 
Spells[17]=new spellPT("Major Cacophony",44,5069,5,"114  D ",5,"28 PP",'700','','','15s','','Body') 
Spells[18]=new spellPT("Deafening Cacophany",50,5069,5,"128  D ",5,"33 PP",'700','','','15s','','Body') 
...
Spells[19]=new spellPT("Motivational Chant",3,5066,5,"+144% SPEED ",5,"",'2000','3.0s','','','6s (pulse)','') 
Spells[20]=new spellPT("Motivational Song",11,5066,5,"+156% SPEED ",5,"",'2000','3.0s','','','6s (pulse)','') 
Spells[21]=new spellPT("Motivational Hymn",23,5066,5,"+174% SPEED ",5,"",'2000','3.0s','','','6s (pulse)','') 
Spells[22]=new spellPT("Motivational Strains",33,5066,5,"+189% SPEED ",5,"",'2000','3.0s','','','6s (pulse)','') 
Spells[23]=new spellPT("Motivational Anthem",43,5066,5,"+204% SPEED ",5,"",'2000','3.0s','','','6s (pulse)','') 
...
Spells[24]=new spellPT("Stunning Yell",5,5071,5,"3 sec ",5,"4 PP",'700','','','10s','3s','Body') 
Spells[25]=new spellPT("Stunning Shout",15,5071,5,"5 sec ",5,"9 PP",'700','','','10s','5s','Body') 
Spells[26]=new spellPT("Stunning Screech",28,5071,5,"7 sec ",5,"17 PP",'700','','','10s','7s','Body') 
Spells[27]=new spellPT("Stunning Bellow",40,5071,5,"9 sec ",5,"25 PP",'700','','','10s','9s','Body') 
...
Spells[28]=new spellPT("Cant of Befuddling",5,5049,5,"70% &nbsp;0% ",5,"",'700','','','30s','20s','Spirit') 
Spells[29]=new spellPT("Cant of Bewilderment",15,5049,5,"85% &nbsp;0% ",5,"",'700','','','30s','20s','Spirit') 
Spells[30]=new spellPT("Cant of Confusion",25,5049,5,"100% &nbsp;0% ",5,"",'700','','','30s','20s','Spirit') 
Spells[31]=new spellPT("Cant of Discord",35,5049,5,"100% 15% ",5,"",'700','','','30s','20s','Spirit') 
Spells[32]=new spellPT("Cant of Perplexity",45,5049,5,"100% 30% ",5,"",'700','','','30s','20s','Body') 
...
Spells[33]=new spellPT("Captivating Melodies",6,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
Spells[34]=new spellPT("Enchanting Melodies",13,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
Spells[35]=new spellPT("Attracting Melodies",20,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
Spells[36]=new spellPT("Pleasurable Melodies",27,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
Spells[37]=new spellPT("Enticing Melodies",34,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
Spells[38]=new spellPT("Alluring Melodies",41,5070,5,"",5,"",'2000','','','5s','10s (pulse)','') 
...
Spells[39]=new spellPT("Compelling Cadence",9,5072,5,"12 sec (pulse) ",5,"",'1500','3.0s','','','12s (pulse)','Body') 
Spells[40]=new spellPT("Constraining Cadence",18,5072,5,"17 sec (pulse) ",5,"",'1500','3.0s','','','17s (pulse)','Body') 
Spells[41]=new spellPT("Coercing Cadence",24,5072,5,"20 sec (pulse) ",5,"",'1500','3.0s','','','20s (pulse)','Body') 
Spells[42]=new spellPT("Compulsory Cadence",36,5072,5,"26 sec (pulse) ",5,"",'1500','3.0s','','','26s (pulse)','Body') 
Spells[43]=new spellPT("Commanding Cadence",42,5072,5,"29 sec (pulse) ",5,"",'1500','3.0s','','','29s (pulse)','Body') 
...
Spells[44]=new spellPT("Comforting Lullaby",10,5057,5,"13 sec ",5,"6 PP",'1500','5.0s','250','','13s','Body') 
Spells[45]=new spellPT("Enchanting Lullaby",15,5057,5,"15 sec ",5,"9 PP",'1500','5.0s','250','','15s','Body') 
Spells[46]=new spellPT("Pacifying Lullaby",21,5057,5,"18 sec ",5,"13 PP",'1500','5.0s','250','','18s','Body') 
Spells[47]=new spellPT("Entrancing Lullaby",28,5057,5,"22 sec ",5,"17 PP",'1500','5.0s','250','','22s','Body') 
Spells[48]=new spellPT("Sedating Lullaby",36,5057,5,"26 sec ",5,"23 PP",'1500','5.0s','250','','26s','Body') 
Spells[49]=new spellPT("Enrapturing Lullaby",45,5057,5,"30 sec ",5,"29 PP",'1500','5.0s','250','','30s','Body') 
...
Spells[50]=new spellPT("Song of Power",10,5068,5,"1 PP Regen ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[51]=new spellPT("Song of Energy",21,5068,5,"2 PP Regen ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[52]=new spellPT("Song of Clarity",30,5068,5,"3 PP Regen ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[53]=new spellPT("Song of the Mind",39,5068,5,"4 PP Regen ",5,"",'700','3.0s','','','6s (pulse)','') 
Spells[54]=new spellPT("Song of Empowering",50,5068,5,"5 PP Regen ",5,"",'700','3.0s','','','6s (pulse)','') 
Lines[5054]=new linePT('Remove Mesmerisation','Target is no longer mesmerised.',5,0) 
Spells[55]=new spellPT("Focusing Chant",27,5054,5,"",5,"6% ",'1500','3.0s','','','','') 
