...
Abilities[11]=new abilityPT("Dual Wield",5,118,5,1,0,0)
Abilities[12]=new abilityPT("Chain Armor",10,104,7,0,0,0)
Abilities[13]=new abilityPT("Evade I",10,113,4,0,0,0)
Abilities[14]=new abilityPT("Short Bows",10,117,5,0,0,0)
Abilities[15]=new abilityPT("Protect I",15,109,4,0,0,0)
Abilities[16]=new abilityPT("Parry",17,107,4,1,0,0)
Abilities[17]=new abilityPT("Intercept",19,110,4,0,0,0)
Abilities[18]=new abilityPT("Dirty Tricks",20,161,4,0,0,0)
Abilities[19]=new abilityPT("Protect II",23,111,4,0,0,0)
Abilities[20]=new abilityPT("Flurry",30,174,4,0,0,0)
Abilities[21]=new abilityPT("Protect III",32,112,4,0,0,0)
Abilities[22]=new abilityPT("Advanced Evade",35,173,4,0,0,0)
Abilities[23]=new abilityPT("Charge",40,196,0,0,0,0)
