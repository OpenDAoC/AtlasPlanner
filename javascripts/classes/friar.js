...
Spells[idx++]=new spellPT("Resilience of the Wanderer",21,80076,80,"+8 HEAT ",80,"17 PP",'1000','3.0s','','','10m','') 
Spells[idx++]=new spellPT("Fortitude of the Wanderer",31,80076,80,"+16 HEAT ",80,"25 PP",'1000','3.0s','','','10m','') 
Spells[idx++]=new spellPT("Piety of the Wanderer",46,80076,80,"+24 HEAT ",80,"39 PP",'1000','3.0s','','','10m','') 
Lines[80077]=new linePT('Buff (Group, Cold Resistance)','Target\'s resistance to Cold damage is increased.',80,0) 
Spells[idx++]=new spellPT("Hearth's Blessing",25,80077,80,"+8 COLD ",80,"20 PP",'1000','3.0s','','','10m','') 
Spells[idx++]=new spellPT("Hearth's Benison",35,80077,80,"+16 COLD ",80,"29 PP",'1000','3.0s','','','10m','') 
Spells[idx++]=new spellPT("Hearth's Gift",48,80077,80,"+24 COLD ",80,"41 PP",'1000','3.0s','','','10m','') 
Lines[80078]=new linePT('Buff (Group, Matter Resistance)','Target\'s resistance to Matter damage is increased.',80,0) 
Spells[idx++]=new spellPT("Attunement to Creation",27,80078,80,"+8 MATTER ",80,"22 PP",'1000','3.0s','','','10m','') 




Spells[idx++]=new spellPT("Blessing of Creation",37,80078,80,"+16 MATTER ",80,"31 PP",'1000','3.0s','','','10m','') 
Spells[idx++]=new spellPT("Oneness with Creation",49,80078,80,"+24 MATTER ",80,"42 PP",'1000','3.0s','','','10m','') 
