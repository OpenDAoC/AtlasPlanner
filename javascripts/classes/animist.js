...
Spells[idx++]=new spellPT("Thorns of Retribution",7,183006,183,"1 DPS ",183,"5 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Grove's Anguish",10,183006,183,"1 DPS ",183,"6 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Wood's Vengeance",14,183006,183,"1 DPS ",183,"9 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Forest's Revenge",21,183006,183,"2 DPS ",183,"13 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Earthspirit's Ire",30,183006,183,"3 DPS ",183,"19 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Nature's Retaliation",39,183006,183,"4 DPS ",183,"25 PP",'1000','4.0s','','','10m','') 
Spells[idx++]=new spellPT("Nature's Heart of Wrath",48,183006,183,"4 DPS ",183,"31 PP",'1000','4.0s','','','10m','') 
