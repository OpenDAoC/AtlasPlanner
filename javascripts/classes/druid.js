...
Spells[idx++]=new spellPT("Cure Nearsight I",20,44099,44,'',44,'30 PP','1500','6.0s','','','','') 
...
Spells[idx++]=new spellPT("Strength of the Sun",23,48076,48,"+8 HEAT ",48,"19 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Resillience of the Sun",32,48076,48,"+16 HEAT ",48,"26 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Aura of the Sun",43,48076,48,"+24 HEAT ",48,"36 PP",'1000','3.0s','','','20m','') 
Lines[48077]=new linePT('Buff (Group, Cold Resistance)','Target\'s resistance to Cold damage is increased.',48,0) 
Spells[idx++]=new spellPT("Warmth of the Badger",24,48077,48,"+8 COLD ",48,"19 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Warmth of the Wolf",35,48077,48,"+16 COLD ",48,"29 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Warmth of the Bear",45,48077,48,"+24 COLD ",48,"38 PP",'1000','3.0s','','','20m','') 
Lines[48078]=new linePT('Buff (Group, Matter Resistance)','Target\'s resistance to Matter damage is increased.',48,0) 
Spells[idx++]=new spellPT("Earth Affinity",26,48078,48,"+8 MATTER ",48,"21 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Earth Bond",38,48078,48,"+16 MATTER ",48,"32 PP",'1000','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Earth Union",48,48078,48,"+24 MATTER ",48,"41 PP",'1000','3.0s','','','20m','') 
...
Spells[idx++]=new spellPT("Claws of the Wild",4,50004,50,"1.6 DPS ",50,"3 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Talons of the Wild",9,50004,50,"2.7 DPS ",50,"6 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Teeth of the Wild",14,50004,50,"3.7 DPS ",50,"9 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Fangs of the Wild",21,50004,50,"5.2 DPS ",50,"13 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Pincers of Wild",27,50004,50,"6.5 DPS ",50,"17 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Stingers of the Wild",36,50004,50,"8.4 DPS ",50,"23 PP",'','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Hooks of the Wild",46,50004,50,"10.5 DPS ",50,"30 PP",'','3.0s','','','20m','') 
